...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__combineReducers__ = __webpack_require__(93);
...
var _ajax = __webpack_require__(101);
...
var receiveIndex = exports.receiveIndex = function receiveIndex(info) {
  return {
    type: RECEIVE_INDEX,
    info: info
  };
...
var fetchAllStashes = exports.fetchAllStashes = function fetchAllStashes(id) {
  return function (dispatch) {
    return ajax.fetchAllStashes(id).then(function (info) {
...
var arrayLikeKeys = __webpack_require__(161),
...
var m=__webpack_require__(4),n=__webpack_require__(7),p=__webpack_require__(0),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(27),B=__webpack_require__(4),C=__webpack_require__(0),ba=__webpack_require__(28),da=__webpack_require__(29),ea=__webpack_require__(30),fa=__webpack_require__(31),ia=__webpack_require__(32),D=__webpack_require__(7);
...
var _header_container = __webpack_require__(100);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(9), __webpack_require__(91)(module)))
...
var _fetch_info = __webpack_require__(21);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchTradeInfo: function fetchTradeInfo(id) {
      return dispatch((0, _fetch_info.fetchTradeInfo)(id));
    }
  };
};
...
var fetchIndex = exports.fetchIndex = function fetchIndex() {
  ...
  var url = "https://www.pathofexile.com/api/trade/data/items";
...
var _stashes = __webpack_require__(107);

var _stashes2 = _interopRequireDefault(_stashes);

var _next_id = __webpack_require__(174);
...
var RootReducer = (0, _redux.combineReducers)({
  stashes: _stashes2.default,
  nextChangeId: _next_id2.default
});
...
var StashesReducer = function StashesReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  Object.freeze(state);
  switch (action.type) {
    case _fetch_info.RECEIVE_TRADE_INFO:
      // TODO
      debugger;
      return state;
    // case RECEIVE_INDEX:
    ...
    case _fetch_info.RECEIVE_ALL_STASHES:
      ...
      var newStashes = action.info.stashes.filter(function (stash) {
        return stash.public && stash.items.length > 0;
      });
      newStashes.forEach(function (stash) {
...
exports.default = StashesReducer;
...
var assignMergeValue = __webpack_require__(47),
    ...
    cloneTypedArray = __webpack_require__(144),
    ...
    safeGet = __webpack_require__(56),
    toPlainObject = __webpack_require__(158);
...
var copyObject = __webpack_require__(159),
    keysIn = __webpack_require__(57);
